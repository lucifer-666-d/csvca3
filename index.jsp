    ...
    <body>
        <div id="wrapper">
            <div id="navigation" class="curved container">
                <span id="nav-home"><a href="${tomcatUrl}">Ghar</a></span>
                <span id="nav-hosts"><a href="${tomcatDocUrl}">Documentation</a></span>
                <span id="nav-config"><a href="${tomcatDocUrl}config/">Configuration</a></span>
                <span id="nav-examples"><a href="${tomcatExamplesUrl}">Examples</a></span>
                <span id="nav-wiki"><a href="https://cwiki.apache.org/confluence/display/TOMCAT/">Wiki</a></span>
                <span id="nav-lists"><a href="${tomcatUrl}lists.html">List manage krr le bhai!!</a></span>
                <span id="nav-help"><a href="${tomcatUrl}findhelp.html">Help chahiye?!</a></span>
                <br class="separator" />
            </div>
            <div id="asf-box">
            ...
            <div id="upper" class="curved container">
                ...
                <div id="notice">
                    ...
                    <div id="tasks">
                        ...
                        <h4><a href="${tomcatDocUrl}security-howto.html">Illegal guns</a></h4>
